...
const MySvg = () => {
  return(
    <svg version="1.1" x="0px" y="0px" width="36px" height="36px" viewBox="0 0 24 24" enableBackground="new 0 24 24 24">
      <g id="Header_x2F_BG" display="none">
        <rect x="-50" y="-138" display="inline" fill="#E3E3E3" width="520" height="520"/>
      </g>
      <g id="Bounding_Boxes">
